...
public class BookInventoryDbContext :
    AbpDbContext<BookInventoryDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(BookInventoryConsts.DbTablePrefix + "Books",
                BookInventoryConsts.DbSchema);
        ...
        {
            b.ToTable(BookInventoryConsts.DbTablePrefix + "Authors",
                BookInventoryConsts.DbSchema);
        ...
        {
            b.ToTable(BookInventoryConsts.DbTablePrefix + "BookTranslations",
                BookInventoryConsts.DbSchema);
